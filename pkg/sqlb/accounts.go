...
var AccountWhere = struct {
	...
	Deleted:   whereHelperbool{field: "\"accounts\".\"deleted\""},
}

// AccountRels is where relationship names are stored.
var AccountRels = struct {
	PasswordAuthn string
}{
...
type accountR struct {
	PasswordAuthn *PasswordAuthn `boil:"PasswordAuthn" json:"PasswordAuthn" toml:"PasswordAuthn" yaml:"PasswordAuthn"`
}
...
func (r *accountR) GetPasswordAuthn() *PasswordAuthn {
	if r == nil {
		return nil
	}
	return r.PasswordAuthn
}
...
var (
	accountAllColumns            = []string{"id", "name", "email", "created_at", "updated_at", "deleted"}
	accountColumnsWithoutDefault = []string{"email"}
	accountColumnsWithDefault    = []string{"id", "name", "created_at", "updated_at", "deleted"}
...
func (q accountQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Account, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlb: failed to execute a one query for accounts")
	}
...
func (q accountQuery) All(ctx context.Context, exec boil.ContextExecutor) (AccountSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlb: failed to assign all query results to Account slice")
	}
...
func (q accountQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: failed to count accounts rows")
	}
...
func (q accountQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlb: failed to check if accounts exists")
	}

	return count > 0, nil
}

// PasswordAuthn pointed to by the foreign key.
func (o *Account) PasswordAuthn(mods ...qm.QueryMod) passwordAuthnQuery {
	...
	return PasswordAuthns(queryMods...)
}

// LoadPasswordAuthn allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (accountL) LoadPasswordAuthn(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAccount interface{}, mods queries.Applicator) error {
	var slice []*Account
	var object *Account
	...
	query := NewQuery(
		qm.From(`password_authns`),
		qm.WhereIn(`password_authns.account_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load PasswordAuthn")
	}

	var resultSlice []*PasswordAuthn
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice PasswordAuthn")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for password_authns")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for password_authns")
	}
	...
	if singular {
		...
		object.R.PasswordAuthn = foreign
		if foreign.R == nil {
			foreign.R = &passwordAuthnR{}
		}
...
// SetPasswordAuthn of the account to the related item.
// Sets o.R.PasswordAuthn to related.
// Adds o to related.R.Account.
func (o *Account) SetPasswordAuthn(ctx context.Context, exec boil.ContextExecutor, insert bool, related *PasswordAuthn) error {
	var err error
	...
	if o.R == nil {
		o.R = &accountR{
			PasswordAuthn: related,
		}
	} else {
		o.R.PasswordAuthn = related
	}

	if related.R == nil {
		related.R = &passwordAuthnR{
			Account: o,
		}
	} else {
		related.R.Account = o
...
func FindAccount(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Account, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlb: unable to select from accounts")
	}
...
func (o *Account) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlb: no accounts provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlb: unable to insert into accounts")
	}
...
func (o *Account) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlb: unable to update accounts, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to update accounts row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: failed to get rows affected by update for accounts")
	}
...
func (q accountQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to update all for accounts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to retrieve rows affected for accounts")
	}
...
func (o AccountSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to update all in account slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to retrieve rows affected all in update all account")
	}
	return rowsAff, nil
}
...
func (o *Account) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("sqlb: no accounts provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("sqlb: unable to upsert accounts, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(accountPrimaryKeyColumns) == 0 {
				return errors.New("sqlb: unable to upsert accounts, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "sqlb: unable to upsert accounts")
	}
...
func (o *Account) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlb: no Account provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to delete from accounts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: failed to get rows affected by delete for accounts")
	}
...
func (q accountQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlb: no accountQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to delete all from accounts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: failed to get rows affected by deleteall for accounts")
	}
...
func (o AccountSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlb: unable to delete all from account slice")
	}
...
func (o *AccountSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlb: unable to reload all in AccountSlice")
	}
...
func AccountExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlb: unable to check if accounts exists")
	}
